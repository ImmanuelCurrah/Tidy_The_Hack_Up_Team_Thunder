...
>>>>>>> cfeb932d4dd035d6720597a9a3ba752b5dc47114
  return (
    <div>
      Event Details
      {events &&
            ...
            return (
              <div className="flex flex-col items-center" key={i}>
                ...
                <div className="bg-emerald-500 mt-2 p-2 rounded-[22px]">
                  ...
                  <h2 className="text-emerald-100">
                    Minimum # of Participants:{e.participants_needed}
                  </h2>
                ...
                {handleComment && (
                  <div className="bg-emerald-500 mt-2 p-8 rounded-full">
                    ...
                    <input></input>
                    <button className="bg-emerald-800 mx-2 rounded-md text-emerald-100 p-1">
                      Edit
                    </button>
                    <button className="bg-emerald-800 mx-2 rounded-md text-emerald-100 p-1">
                      Delete
