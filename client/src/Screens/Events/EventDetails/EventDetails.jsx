    ...
    <div>
      ...
      {events && events.filter((e) => Number(e.id) === Number(id)).map((e, i) => {
        return <div className='flex flex-col items-center' key={i}>
          ...
          <button className='bg-emerald-800 my-2 rounded-md text-emerald-100 p-1' onClick={(e) => {
            e.preventDefault();
          ...
          {handleComment && <div className='bg-emerald-500 mt-2 p-8 rounded-full'>
          ...
          <button className='bg-emerald-800 my-2 rounded-md text-emerald-100 p-1' onClick={(e) => { e.preventDefault(); handleUpdate(e); }}>Update</button>
          <button className='bg-emerald-800 my-2 rounded-md text-emerald-100 p-1' onClick={(e) => { e.preventDefault(); handleParticipate(e); }}>Participate</button>
          </div>
      })}
    </div>
  )
